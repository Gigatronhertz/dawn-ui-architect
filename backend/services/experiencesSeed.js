/**
 * Lagos curated experiences — seeded into the `experiences` table on first boot.
 * Mirrors src/data/experiences.ts (the source of truth during initial build).
 */

const LAGOS_EXPERIENCES_SEED = [
  {
    id: 'beach-camp',
    name: 'Beach Camping',
    ...
    schedule: [
      ...
      { time: '10:30', activity: 'Beach games & open swimming', details: 'Volleyball, frisbee, body surfing �� water is calm.' },
      { time: '13:00', activity: 'Lunch on the beach', details: 'Grilled fish, jollof rice, cold drinks.' },
      { time: '15:00', activity: 'Kayaking & banana boat', details: 'Rides available — ₦1,500 extra per ride.' },
      { time: '18:30', activity: 'Golden hour', details: 'The sunset from Tarkwa Bay is genuinely unreal.' },
    ...
    scheduleOverrides: {
      1: [
        ...
        { time: '09:00', activity: 'Sunrise swim & beach walk', details: 'Low tide reveals more beach.' },
      ...
      2: [
        ...
        { time: '10:30', activity: 'Speedboat back to CMS Marina', details: 'Return ride included — arrives back by midday.' },
      ],
    },
    highlights: [
    ...
    groupMin: 5,
    groupMax: 40,
    notes: '3-day cap. For squads wanting more time: book back-to-back.',
  },

  {
    ...
    schedule: [
      ...
      { time: '14:00', activity: 'Lazy river & wave pool', details: 'Squad floats, squad photos.' },
    ...
    groupMin: 4,
    groupMax: 50,
    notes: 'This is a 1-day experience — you genuinely won\'t need more time.',
  },

  {
    ...
    schedule: [
      { time: '10:00', activity: 'Arrive at the Upside Down House, VI', details: 'Walking distance from most VI hotels.' },
      { time: '10:15', activity: 'Room-by-room guided experience', details: 'Every room is a different installation — roughly 90 minutes.' },
      { time: '11:45', activity: 'Squad photo session', details: 'Resident photographer captures the full chaos.' },
      { time: '12:30', activity: 'Brunch at partner café', details: 'Included — the food is genuinely good.' },
      { time: '14:00', activity: 'Optional: Onikan stroll', details: 'National Museum and Rele Gallery are a 10-minute walk.' },
    ],
    scheduleOverrides: {},
    highlights: [
...

  {
    ...
    schedule: [
      { time: '09:30', activity: 'Sneaker Gallery, Yaba', details: 'Nigeria\'s premier sneaker culture space.' },
      { time: '11:00', activity: 'Yaba street art trail', details: 'Guided walk through Lagos\'s best murals.' },
      { time: '12:30', activity: 'Rooftop brunch', details: 'Panoramic Lagos views. Included in your rate.' },
      { time: '14:00', activity: 'Balogun market immersion', details: 'Guided means no tourist markup and no getting lost.' },
      { time: '15:30', activity: 'Content & squad photos', details: 'Curated stops on Lagos Island.' },
      { time: '16:30', activity: 'Free time on Lagos Island', details: 'Guide can recommend a rooftop bar (not included).' },
    ],
    scheduleOverrides: {},
    highlights: [
      'Only curated sneaker + street art day experience in Lagos',
      'Professional photographer throughout — not just at one spot',
      'Balogun market with a guide — the authentic version',
    ],
    groupMin: 3,
    groupMax: 20,
    notes: null,
...

  {
    ...
    schedule: [
      { time: '07:30', activity: 'First-entry slot — dawn light in the canopy', details: 'Wildlife is most active before 9am.' },
      { time: '08:00', activity: 'Guided nature walk', details: 'Spot vervet monkeys, exotic birds, and monitor lizards.' },
      { time: '09:00', activity: 'The canopy walkway', details: '400m of suspension bridge, 22m above the forest floor.' },
      { time: '10:30', activity: 'Picnic brunch', details: 'We set it up. You show up and eat.' },
      { time: '12:00', activity: 'Free exploration', details: 'Photography, hammocks, more wildlife watching.' },
    ...
    groupMin: 3,
    groupMax: 40,
    notes: 'Strongly recommend the 7:30am first-entry slot.',
  },

  {
    ...
    schedule: [
      { time: '08:30', activity: 'Jankara Market, CMS', details: 'Herbs, produce, and the full morning energy of Lagos Island.' },
      { time: '10:00', activity: 'Nok by Alara Gallery', details: 'Nigerian contemporary art at a genuinely world-class standard.' },
      ...
      { time: '14:30', activity: 'Lagos Harbour boat ride', details: '25-minute ride from CMS jetty.' },
      { time: '16:00', activity: 'Street food closing round', details: 'Suya, puff-puff, coconut candy — the full circuit.' },
      { time: '17:30', activity: 'End of day', details: 'Guide recommends the right rooftop bar for the evening.' },
    ],
    scheduleOverrides: {
      1: [
        ...
        { time: '12:00', activity: 'Point of No Return Beach', details: 'The exact beach where enslaved people left Nigeria for the last time.' },
        { time: '14:00', activity: 'Lunch in Badagry', details: 'Fresh catch from the lagoon. Covered in your rate.' },
    ...
    groupMin: 4,
    groupMax: 25,
    notes: 'Day 2 is a different itinerary entirely — Badagry history and coast.',
  },
];

module.exports = { LAGOS_EXPERIENCES_SEED };
