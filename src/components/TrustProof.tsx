  ...
  return (
    <section className="py-24 md:py-32 bg-ink overflow-hidden">
      <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="font-marcellus text-3xl md:text-4xl text-paper leading-snug mb-3">
            Real trips, real peace of mind.
          </h2>
          <p className="font-jost font-light text-base text-paper/60 max-w-md">
            Every banner here is styled after the actual in-app reminder — not a stock photo. Copy is a draft, confirm exact wording against the live reminder emails.
          </p>
        </div>

        <div ref={reveal.ref} className="relative flex justify-center py-6">
          {/* decorative offset block behind the phone */}
          <div className="absolute w-64 sm:w-72 h-[420px] sm:h-[480px] bg-signal rounded-[2.5rem] rotate-[-4deg] translate-x-3" />
          ...
          >
            ...
            <div className="mt-9 px-3 flex flex-col gap-2.5">
              {NOTIFICATIONS.map((n, i) => (
                ...
                >
                  <span className="shrink-0 w-7 h-7 rounded-lg bg-signal border-2 border-ink flex items-center justify-center mt-0.5">
