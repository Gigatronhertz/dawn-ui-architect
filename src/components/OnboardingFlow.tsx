    ...
    <div className="mx-auto max-w-6xl px-6">
      ...
      <div className="mt-6 rounded-2xl bg-card ring-hairline p-6 md:p-8 grid md:grid-cols-[1fr,auto] gap-6 items-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-whatsapp text-white px-6 py-3 text-sm font-medium whitespace-nowrap hover:scale-[1.02] transition-transform"
        >
